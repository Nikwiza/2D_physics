...
while running:
    ...
    # screen.fill("red", ((vertices2[0].x, vertices2[0].y), (3, 3))) 
    # screen.fill("red", ((vertices2[1].x, vertices2[1].y), (3, 3))) 
    # screen.fill("red", ((vertices2[2].x, vertices2[2].y), (3, 3))) 
    # screen.fill("red", ((vertices2[3].x, vertices2[3].y), (3, 3))) 
